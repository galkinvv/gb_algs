...
{
      17,     0,    -1,    21,    18,    21,    -1,    21,    -1,    22,
      -1,    18,    20,    22,    -1,    10,    -1,    11,    -1,    12,
      -1,    13,    -1,    19,    -1,    20,    19,    -1,    -1,    20,
      -1,    23,    -1,     3,    -1,     5,    -1,    23,     7,    23,
      -1,    23,     6,    23,    -1,    23,     8,    23,    -1,     6,
      23,    -1,    23,     9,     3,    -1,    14,    23,    15,    -1
};
...
#line 110 "parse.ypp"
    {
				(yyval.pl)=new CPolynomial(*((yyvsp[(1) - (3)].pl))+*((yyvsp[(3) - (3)].pl)));
				tempVars.push((yyval.pl));
			;}
    break;
...
#line 125 "parse.ypp"
    {
				(yyval.pl)=new CPolynomial(*((yyvsp[(2) - (2)].pl)));
				CModular coeff(-1);
				*((yyval.pl))*=coeff;
				tempVars.push((yyval.pl));
			;}
...
#line 131 "parse.ypp"
    { 
				unsigned int power = (unsigned int) (yyvsp[(3) - (3)].num);
				(yyval.pl)=new CPolynomial(degree(*((yyvsp[(1) - (3)].pl)),power));
				tempVars.push((yyval.pl));			
			;}
    break;
